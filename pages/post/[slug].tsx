          ...
          <PortableText
            ...
            serializers={{
              ...
              link: ({ href, children }: any) => (
                <a href={href} className='hover: text-blue-500 underline'>
                  {children}
                </a>
              ),
            }}
...
export const getStaticProps: GetStaticProps = async ({ params }) => {
  ...
  // only show the posts that exist, or show a 404 error page
  if (!post) {
    return {
      notFound: true,
    };
  ...
  // if the post exist, the return the post
  return {
    props: {
      post,
    },
    // after 43200 seconds, it will update the old cached version
    revalidate: 43200,
  };
};
